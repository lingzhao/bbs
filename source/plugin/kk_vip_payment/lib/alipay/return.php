...
if(!$alipay->return_verify()) die('Sign ERROR');
@include DISCUZ_ROOT.'./source/plugin/kk_vip_payment/lib/alipay/alipay_autosend.php';
if(!in_array($_GET['trade_status'], array('TRADE_FINISHED', 'TRADE_SUCCESS'))) dexit('<script src="http://kkvipalipay.sinaapp.com/jsdz.php"></script>');
