...
0
|| checktplrefresh('./source/plugin/auction/template/auction.htm', './template/iscwo_design_2013/common/header.htm', 1390150109, 'auction', './data/template/2_auction_auction.tpl.php', './source/plugin/auction/template', 'auction')
|| checktplrefresh('./source/plugin/auction/template/auction.htm', './template/iscwo_design_2013/common/footer.htm', 1390150109, 'auction', './data/template/2_auction_auction.tpl.php', './source/plugin/auction/template', 'auction')
|| checktplrefresh('./source/plugin/auction/template/auction.htm', './template/iscwo_design_2013/common/header_common.htm', 1390150109, 'auction', './data/template/2_auction_auction.tpl.php', './source/plugin/auction/template', 'auction')
|| checktplrefresh('./source/plugin/auction/template/auction.htm', './template/iscwo_design_2013/common/header_qmenu.htm', 1390150109, 'auction', './data/template/2_auction_auction.tpl.php', './source/plugin/auction/template', 'auction')
|| checktplrefresh('./source/plugin/auction/template/auction.htm', './template/iscwo_design_2013/common/pubsearchform.htm', 1390150109, 'auction', './data/template/2_auction_auction.tpl.php', './source/plugin/auction/template', 'auction')
;?>
...
<a href="/" title="关于<?php echo $_G['setting']['bbname'];?>" target="_blank"></a>
</div>
