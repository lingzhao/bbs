...
<div class="f_c">
<h3 class="flb">
<em id="return_<?php echo $_GET['handlekey'];?>">购买软件</em>
<span>
...
<tr>
<td>价格(<?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['title'];?>)</td>
<td><?php echo $attach['price'];?> <?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['unit'];?></td>
</tr>
<?php if($status != 1) { ?>
<tr>
<td>余额(<?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['title'];?>)</td>
...
<div class="o pns">
<?php if($status != 1) { ?>
<button class="pn pnc" type="submit" name="paysubmit" value="true"><span><?php if($status == 0) { ?>购买软件<?php } else { ?>免费购买<?php } ?></span></button>
<?php } ?>
