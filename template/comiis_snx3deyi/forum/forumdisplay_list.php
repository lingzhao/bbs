<?php echo '114Ô´ÂëÍø unn114.com';exit;?>
							...
							<tbody id="$thread[id]">
								<tr>
									<td class="icn">
										...
										<!--{else}-->
							<!--{if $thread[replies] == '0' && strtotime($thread['dateline'])>time()-3600*24*5}-->
							<img src="{IMGDIR}/folder_news.gif" />
							<!--{elseif $thread[views] >100 }-->
							<img src="{IMGDIR}/folder_hot.gif" />
							<!--{else}-->
						...
						<ul id="waterfall" class="ml waterfall cl">
							...
							<li style="width:{$waterfallwidth}px;">
								...
								<h3 class="xw0">
									...
									<!--{if in_array($thread['displayorder'], array(1, 2, 3, 4))}--><em class="sum pin">{lang thread_stick}</em> <!--{/if}--><!--{if in_array($thread['digest'], array(1, 2, 3))}--><em class="sum digest">{lang thread_digest}</em> <!--{/if}-->
