...
<!--{if empty($gid)}-->
	<div class="wp">
		<!--[diy=diy1]--><div id="diy1" class="area"><div id="frameVh8L43" class=" frame move-span cl frame-1"><div id="frameVh8L43_left" class="column frame-1-c"><div id="frameVh8L43_left_temp" class="move-span temp"></div><!--{block/194}--></div></div></div><!--[/diy]-->
	</div>
<!--{/if}-->
...
<div class="comiis_oneline_smallbox"><!--[diy=comiis_lsng01]--><div id="comiis_lsng01" class="area"></div><!--[/diy]--></div>
<div class="comiis_bodyadone"><!--[diy=comiis_lsng07]--><div id="comiis_lsng07" class="area"></div><!--[/diy]--></div>
  </div>
<div class="comiis_oneline_right">
  <div class="comiis_h2title"><strong>热门话题</strong></div>
<div class="comiis_oneline_smallboxone" style="height:395px;">
  <!--[diy=comiis_lsng05]--><div id="comiis_lsng05" class="area"></div><!--[/diy]--> 
</div>		 
  </div>
  <div class="comiis_oneline_middle">
<div class="comiis_oneline_middlebox">
  <!--[diy=comiis_lsng03]--><div id="comiis_lsng03" class="area"></div><!--[/diy]-->  
  <!--[diy=comiis_lsng04]--><div id="comiis_lsng04" class="area"></div><!--[/diy]--> 		  
</div>
  </div>
</div>    
</div>
<div style="clear:both;"></div>
  <div class="comiis_h2title"><strong>图文直播</strong></div>
<div class="comiis_oneline_smallboxone kmdxc">
<!--[diy=comiis_lsng_pic]--><div id="comiis_lsng_pic" class="area"></div><!--[/diy]-->
</div>		 
  </div>
<div style="clear:both;"></div>
	<!--{/if}-->
